  ...
  return (
    <>
      ...
      <div className="market-statistics">
                      ...
                      <div className="ms-community-right">
                        <div className="ms-community-price">
                          ...
                          <div className={`ms-community-price-change ${community.priceChange > 0 ? "positive" : "negative"}`}>
                            {community.priceChange > 0 ? <TrendingUp size={14} /> : <TrendingDown size={14} />}
        ...
        {/* Methodology Modal */}
        {showMethodology && (
          <div className="ms-methodology-overlay">
            <div className="ms-methodology-modal">
              <button
                className="ms-methodology-close"
              ...
              <p className="ms-methodology-intro">
                Our market statistics are calculated using aggregated historical
                and real-time real estate data. Below is how each metric is derived.
              </p>

              <div className="ms-methodology-section">
                <h4>Total Active Listings</h4>
                <p className="ms-term-definition">
                  <strong>What it means:</strong> The total number of properties currently available for sale in the market. This includes all property types (residential, commercial, luxury) that are actively listed and not yet sold.
                </p>
                <p>
                  <strong>How it's calculated:</strong> Sum of all currently active property listings across selected cities, property types, and filters.
                </p>
                <div className="ms-formula">
                  <code>Total Listings = Σ (listings per community)</code>
                  <span className="ms-formula-example">Example: 342 + 156 + 428 + 567 + 289 = 1,782 listings</span>
                </div>
              </div>

              <div className="ms-methodology-section">
                <h4>Average Price per Sqft</h4>
                <p className="ms-term-definition">
                  <strong>What it means:</strong> The average cost to buy one square foot of property in a given area. This metric helps compare property values across different neighborhoods regardless of property size.
                </p>
                <p>
                  <strong>How it's calculated:</strong> Averaging the price per square foot of all selected communities.
                </p>
                <div className="ms-formula">
                  <code>Avg Price/Sqft = (Σ community avg prices) ÷ (number of communities) ÷ 1000</code>
                  <span className="ms-formula-example">Example: ($1.15M + $1.52M + $890K + $680K + $520K) ÷ 5 ÷ 1000 = $952/sqft</span>
                </div>
              </div>
              ...
              <div className="ms-methodology-section">
                <h4>Rental Yield</h4>
                <p className="ms-term-definition">
                  <strong>What it means:</strong> The annual return on investment you can expect from renting out a property, expressed as a percentage. Higher yield means better rental income relative to property cost. A yield of 5-6% is generally considered good for residential properties.
                </p>
                <p>
                  <strong>How it's calculated:</strong> Annual rental income divided by the property value, multiplied by 100.
                </p>
                <div className="ms-formula">
                  <code>Rental Yield = (Annual Rental Income ÷ Property Value) × 100</code>
                  <span className="ms-formula-example">Example: ($58,000 ÷ $1,000,000) × 100 = 5.8%</span>
                </div>
              </div>
              ...
              <div className="ms-methodology-section">
                ...
                <p className="ms-term-definition">
                  <strong>What it means:</strong> How much property values have increased over time. Positive appreciation means properties are gaining value, making it a good time to invest. Negative appreciation (depreciation) indicates declining values.
                </p>
                <p>
                  <strong>How it's calculated:</strong> The percentage change in property prices compared to the previous period.
                </p>
                <div className="ms-formula">
                  <code>Appreciation = ((Current Price - Previous Price) ÷ Previous Price) × 100</code>
                  <span className="ms-formula-example">Example: (($1,072,000 - $1,000,000) ÷ $1,000,000) × 100 = 7.2%</span>
                </div>
              </div>

              <div className="ms-methodology-section">
                <h4>Community Pricing Trends</h4>
                <p className="ms-term-definition">
                  <strong>What it means:</strong> A visual representation of how property prices have changed month-over-month in different areas. This helps identify which neighborhoods are appreciating faster and seasonal price patterns.
                </p>
                <p>
                  <strong>How it's calculated:</strong> Monthly average price per square foot grouped by locality type (Downtown, Suburban, Waterfront).
                </p>
                <div className="ms-formula">
                  <code>Monthly Avg = Σ (price/sqft per property) ÷ (number of properties sold)</code>
                  <span className="ms-formula-example">Tracked monthly for Downtown, Suburban, and Waterfront zones</span>
                </div>
              </div>

              <div className="ms-methodology-section">
                <h4>Demand vs Supply Index</h4>
                <p className="ms-term-definition">
                  <strong>What it means:</strong> A measure of market balance between buyers (demand) and available properties (supply). High demand with low supply = seller's market (prices rise). High supply with low demand = buyer's market (prices fall or stagnate).
                </p>
                <p>
                  <strong>How it's calculated:</strong> Normalized scores (0-100) comparing buyer interest against available inventory.
                </p>
                <div className="ms-formula">
                  <code>Demand Index = (Active Buyers ÷ Avg Buyers Baseline) × 100</code>
                  <code>Supply Index = (Available Listings ÷ Avg Listings Baseline) × 100</code>
                  <span className="ms-formula-example">High Demand: Demand &gt; Supply + 10 | Balanced: |Demand - Supply| ≤ 10 | Oversupplied: Supply &gt; Demand + 10</span>
                </div>
              </div>
              ...
              <div className="ms-methodology-section">
                ...
                <p className="ms-term-definition">
                  <strong>What it means:</strong> An overall quality-of-life rating (0-100) for a location based on access to essential services. Scores above 80 are considered excellent, 60-79 good, and below 60 average. Higher scores typically correlate with higher property values.
                </p>
                <p>
                  <strong>How it's calculated:</strong> Weighted composite score based on proximity to schools, healthcare, transport, and shopping.
                </p>
                <div className="ms-formula">
                  <code>Score = (Schools × 0.25) + (Healthcare × 0.25) + (Transport × 0.30) + (Shopping × 0.20)</code>
                  <span className="ms-formula-example">Each category scored 0-100 based on distance and count of facilities within 2 miles</span>
                </div>
              </div>
            </div>
          </div>
