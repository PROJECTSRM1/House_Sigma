...
export const newlyAdded: Property[] = [
  {
    id: 1,
    image: "/src/assets/alberta_Files/alberta1.jpg",
    price: "$63,900",
  ...
  {
    id: 2,
    image: "/src/assets/alberta_Files/alberta2.jpg",
    price: "$250,000",
  ...
  {
    id: 3,
    image: "/src/assets/alberta_Files/alberta3.jpg",
    price: "$352,900",
...
export const bestForSchools: Property[] = [
  {
    id: 4,
    image: "/src/assets/alberta_Files/alberta4.jpg",
    price: "$366,000",
  ...
  {
    id: 5,
    image: "/src/assets/alberta_Files/alberta5.jpg",
    price: "$284,900",
  ...
  {
    id: 6,
    image: "/src/assets/alberta_Files/alberta6.jpg",
    price: "$359,900",
...
export const featuredListings: Property[] = [
  {
    id: 7,
    image: "/src/assets/alberta_Files/alberta7.jpg",
    price: "$539,900",
  ...
  {
    id: 8,
    image: "/src/assets/alberta_Files/alberta8.jpg",
    price: "$499,000",
  ...
  {
    id: 9,
    image: "/src/assets/alberta_Files/alberta9.jpg",
    price: "$299,900",
...
export const highGrowth: Property[] = [
  {
    id: 10,
    image: "/src/assets/alberta_Files/alberta10.jpg",
    price: "$790,000",
  ...
  {
    id: 11,
    image: "/src/assets/alberta_Files/alberta11.jpg",
    price: "$1,195,000",
  ...
  {
    id: 12,
    image: "/src/assets/alberta_Files/alberta12.jpg",
    price: "$354,998",
...
export const soldBelowBought: Property[] = [
  {
    id: 13,
    image: "/src/assets/alberta_Files/alberta13.jpg",
    price: "$317,000",
  ...
  {
    id: 14,
    image: "/src/assets/alberta_Files/alberta14.jpg",
    price: "$90,100",
  ...
  {
    id: 15,
    image: "/src/assets/alberta_Files/alberta15.jpg",
    price: "$175,000",
...
export const highReturns: Property[] = [
  {
    id: 16,
    image: "/src/assets/alberta_Files/alberta16.jpg",
    price: "$425,000",
  ...
  {
    id: 17,
    image: "/src/assets/alberta_Files/alberta17.jpg",
    price: "$380,000",
  ...
  {
    id: 18,
    image: "/src/assets/alberta_Files/alberta18.jpg",
    price: "$550,000",
...
export const justSold: Property[] = [
  {
    id: 19,
    image: "/src/assets/alberta_Files/alberta19.jpg",
    price: "$685,000",
    soldFor: "$660,000",
    status: "Sold",
    soldDate: "2 days ago",
  ...
  {
    id: 20,
    image: "/src/assets/alberta_Files/alberta20.jpg",
    price: "$520,000",
    soldFor: "$505,000",
    status: "Sold",
    soldDate: "3 days ago",
  ...
  {
    id: 21,
    image: "/src/assets/alberta_Files/alberta21.jpg",
    price: "$399,900",
    soldFor: "$385,000",
    status: "Sold",
    soldDate: "5 days ago",
